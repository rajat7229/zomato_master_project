    ...
    <div className='flex w-full items-center justify-between lg:hidden container m-auto py-2'>
      ...
      <div className='flex items-center gap-3 relative'>
        ...
        className='border border-gray-300 text-zomato-400 w-9 h-9 rounded-full'>
          <img src='https://cdn.xxl.thumbs.canstockphoto.com/young-man-avatar-cartoon-character-profile-picture-young-afroamerican-man-avatar-cartoon-character-image_csp70796176.jpg' alt='avatar' className='h-19 w-19 rounded-full object-cover'/>
        </div>
        {isDropdownOpen && (
          <div className='absolute shadow-lg py-3 -bottom-20 -right-4 w-full z-20 flex flex-col gap-2 bg-white border border-gray-200'>
      ...
      <div className="flex items-center gap-3 relative">
        {user?.fullName ? (
          <>
            ...
            >
              <img
                src="https://cdn.xxl.thumbs.canstockphoto.com/young-man-avatar-cartoon-character-profile-picture-young-afroamerican-man-avatar-cartoon-character-image_csp70796176.jpg"
                alt="avatar"
...
const Navbar = () => {
  ...
  <nav className='p-4 lg:py-2 flex bg-white shadow-md lg:shadow-none lg:border-b-2 border-gray-100 w-full items-center'>
    <MobileNav user={user} setIsDropdownOpen={setIsDropdownOpen} isDropdownOpen={isDropdownOpen} />
